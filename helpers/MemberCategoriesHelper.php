...
class MemberCategoriesHelper extends BaseHelper
{
    ...
    public function AddItem()
    {
        ...
        $item = $xpdo->newObject('MemberCategories');
    ...
    public function GetItems()
    {
        global $xpdo;
          ...
          $query = $xpdo->newQuery('MemberCategories');
          $query->sortby('Sort', 'ASC');

        //   $categoriesCount = $xpdo->getCount('MemberCategories', $query);
        //   $limit = 20;
        ...
        //   $query->limit($limit, $offset);
          ...
          $allObj = $xpdo->getCollection('MemberCategories' ,$query);
          ...
          if (empty($allObj)) {
            ...
            {
                $output .= new LoadChunk('date', 'admin/memberCategories', array(
    ...
    public function GetItem()
    {
        ...
        $item = $xpdo->getObject('MemberCategories', array('ID' => $itemID));
