...
<div class="fixed-action-btn" style="bottom: 45px; right: 24px;" id="addAlertBtnCnt">
  ...
  <ul>
    <li>
      <a class="btn-floating btn-large blue tooltipped modal-trigger popupforms" data-position="left" data-delay="50" data-tooltip="Add Event"  id="addNews">
      ...
      <form id="addGLI" class="col s12">
        <input type="hidden" name="operation" value="add" />
          ...
          <div class="input-field col s6">
            <input type="date" class="timepicker" name="start" class="validate">
            <label for="dir-start">
               Start Time
            </label>
          </div>
          ...
          <div class="input-field col s6">
            <input type="date" class="timepicker" name="end" class="validate">
            <label for="dir-end">
               End Time
            </label>
          </div>
  ...
  <div class="modal-content">
    ...
    <div class="row">
      <form id="editGLI" class="col s12">
        ...
        <div class="row">
          <div class="input-field col s6">
            <input type="date" class="timepicker" name="edit_start" id="edit_start">
          ...
          <div class="input-field col s6">
            <input type="date" class="timepicker" name="edit_end" id="edit_end">
