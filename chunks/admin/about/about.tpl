    ...
    <form id="editGL" class="col s12">
      ...
      <div id="TabENEdit" class="row">
        <div class="input-field col s12">
          <input
            id="first_edit_title_en"
            name="first_edit_title_en"
            type="text"
          />
        ...
        <div class="input-field col s12">
          <textarea
            id="first_edit_description_en"
            name="first_edit_description_en"
          ></textarea>
      ...
      <div id="TabAREdit" class="row">
        <div class="input-field col s12">
          <input
            id="first_edit_title_ar"
            name="first_edit_title_ar"
            type="text"
          />
        ...
        <div class="input-field col s12">
          <textarea
            id="first_edit_description_ar"
            name="first_edit_description_ar"
          ></textarea>
...
<div class="main-button">
  <a href="#" class="waves-effect waves-light btn blue darken-2" id="btnSave"
    >Save</a
  >
</div>
<!-- </div> -->
