...
<div class="row">
  <div class="large-12 columns">
    ...
    <p class="subtitle-text">
      Manage About Items on your website.
    </p>
    ...
    <div class="row">
      <form id="editGL" class="col s12">
        ...
        <div id="TabENEdit" class="row">
          ...
          <div class="input-field col s12">
            <input id="edit_job_title_en" name="edit_title_en" type="text" />
            <label for="dir-edit_job_title_en">
              English job Title
            </label>
          </div>
          <div class="input-field col s12">
        ...
        <div id="TabAREdit" class="row">
          ...
          <div class="input-field col s12">
            <input
              id="edit_job_title_ar"
              name="edit_job_title_ar"
              type="text"
            />
            <label for="dir-edit_job_title_ar">
              Arabic job Title
            </label>
          </div>
          <div class="input-field col s12">
