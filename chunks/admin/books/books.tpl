...
<div class="fixed-action-btn" style="bottom: 45px; right: 24px;" id="addAlertBtnCnt">
  ...
  <ul>
    <li>
      <a class="btn-floating btn-large blue tooltipped modal-trigger popupforms" data-position="left" data-delay="50" data-tooltip="Upload CSV File"  id="uploadBooks">
...
<!-- Upload Books Modal Structure -->
<div id="uploadBooksModal" class="modal bottom-sheet" style="max-height: 80%;">
  <div class="modal-content">
    <h4>
      Upload Books File
    </h4>
      ...
      <form id="uploadGLI" class="col s12">
        ...
        <div class="file-field input-field col s12">
          <div class="btn blue darken-2">
            ...
            <input name="booksFile" type="file" class="validate">
          </div>
          <div class="file-path-wrapper">
            <input class="file-path" type="text">
          </div>
  ...
  <div class="modal-footer">
    <a href="#" class="waves-effect waves-light btn blue darken-2" id="btnBooksUpload">Save</a>
  </div>
</div>
<!-- Upload Books End -->
  ...
  <div class="modal-content">
    ...
    <div class="row">
      <form id="editGL" class="col s12">
        <input type="hidden" name="operation" value="editBook" />
