  ...
  <ul>
    <li>
      <a class="btn-floating btn-large blue tooltipped modal-trigger popupforms" data-position="left" data-delay="50"
        data-tooltip="Add New Image" id="addItem">
        <i class="material-icons">announcement</i>
      </a>
    </li>
    <li class="edit-btn">
      <a href="#!" id="uploadPhotos" onclick="fnUploadPhotoModal();">
        <i class="material-icons " style="vertical-align: middle;">picture_in_picture</i> Upload Images</a>
    </li>
  </ul>
</div>
...
<div class="row">
  <div class="large-12 columns">
    ...
    <p class="subtitle-text">
      Manage Images Items on your website.
    </p>
...
<div id="uploadModal" class="modal bottom-sheet" style="overflow-y: auto;max-height: 100%;">
  ...
  <div class="modal-footer">
    <a href="#" class="waves-effect waves-light btn blue darken-2" id="btnSaveUploads">Close</a>
  </div>
</div>
<!-- Upload Photos End -->